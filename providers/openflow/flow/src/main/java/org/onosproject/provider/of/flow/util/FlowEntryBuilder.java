            ...
            switch (act.getType()) {
                ...
                case EXPERIMENTER:
                    ...
                    if (exp.getExperimenter() == 0x80005A06 ||
                        ...
                        CircuitSignalID circuitSignalID = ((OFOxmExpOchSigid) ct.getField()).getValue();
...
//            break;
            ...
            OduSignalId oduSignalId = OduSignalId.oduSignalId(oduSignalID.getTributaryPortNumber(),
                    oduSignalID.getTributarySlotNum(),
                    oduSignalID.getTributarySlotMap());
...
//            break;
        ...
        case METADATA:
        case MPLS_TC:
        case CIRCUIT_OCH_SIGID:
        case CIRCUIT_OCH_SIGID_BASIC:
        case CIRCUIT_OCH_SIGTYPE:
        case CIRCUIT_OCH_SIGTYPE_BASIC:
        case SCTP_DST:
        case SCTP_SRC:
    ...
    private TrafficSelector buildSelector() {
        ...
        for (MatchField<?> field : match.getMatchFields()) {
            ...
            case IPV6_EXTHDR:
                ...
                break;
            case CIRCUIT_OCH_SIGID:
                CircuitSignalID sigId = match.get(MatchField.CIRCUIT_OCH_SIGID);
                ...
                break;
            case CIRCUIT_OCH_SIGTYPE:
                U8 sigType = match.get(MatchField.CIRCUIT_OCH_SIGTYPE);
                builder.add(matchOchSignalType(lookupOchSignalType((byte) sigType.getValue())));
                break;
            case EXP_OCH_SIGID:
                try {
                    CircuitSignalID expSigId = match.get(MatchField.EXP_OCH_SIGID);
                    builder.add(matchLambda(Lambda.ochSignal(
            ...
            case EXP_OCH_SIGTYPE:
                ...
                break;
            case EXP_ODU_SIGID:
                OduSignalId oduSignalId = OduSignalId.oduSignalId(
                        match.get(MatchField.EXP_ODU_SIGID).getTributaryPortNumber(),
                        match.get(MatchField.EXP_ODU_SIGID).getTributarySlotNum(),
                        match.get(MatchField.EXP_ODU_SIGID).getTributarySlotMap());
