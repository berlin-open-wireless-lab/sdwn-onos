...
class OFChannelHandler extends ChannelInboundHandlerAdapter implements ChannelOutboundHandler {
...
//                    h.channel.write(Collections.singletonList(reply));
    ...
    //**********************************
    //  Inbound Channel Handler methods
    //**********************************
...
//    }
    ...
    //***********************************
    //  Outbound Channel Handler methods
    //***********************************
    ...
    @Override
    public void connect(ChannelHandlerContext ctx, SocketAddress remote, SocketAddress local, ChannelPromise p)
        throws Exception {
    ...
    private void sendHandshakeHelloMessage() throws IOException {
        ...
        log.info("Sending OF_13 Hello to {}", channel.remoteAddress());
