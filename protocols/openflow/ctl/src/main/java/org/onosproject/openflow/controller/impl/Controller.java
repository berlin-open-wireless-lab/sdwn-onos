...
public class Controller {
    ...
    private ChannelFactory<NioServerSocketChannel> execFactory;
        ...
        try {
            ...
            bootstrap.option(ChannelOption.SO_REUSEADDR, true)
                    ...
                    .childOption(ChannelOption.WRITE_BUFFER_WATER_MARK,
                                  new WriteBufferWaterMark(Controller.SEND_BUFFER_SIZE,
                                                           Controller.SEND_BUFFER_SIZE))
                    .childHandler(new OpenflowChannelInitializer(this, null, sslContext));

            cg = new DefaultChannelGroup(new DefaultEventLoop());
    ...
    private ServerBootstrap createServerBootStrap() {
        execFactory = NioServerSocketChannel::new;
